...
public class MemberSignupsConsumerTest {
    ...
    public void testHandleRecords_output() {
        ...
        assertEquals("key=2, value=ROSENBERG, WILLOW, topic=member_signups, partition=0, offset=1n", systemOutContent.toString());
    }
    ...
    public void testHandleRecords_multiple() {
        ...
        assertEquals("key=2, value=ROSENBERG, WILLOW, topic=member_signups, partition=0, offset=1\nkey=5, value=HARRIS, ALEXANDER, topic=member_signups, partition=3, offset=4\n", systemOutContent.toString());
    }
